...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/Bitcoin-Eco-Core-Developers/Bitcoin-Eco>";
    const std::string URL_WEBSITE = "<https://btc-eco.com/>";
    ...
    return FormatParagraph(strprintf("Copyright (C) %i-%i The Bitcoin Core Developers", 2009, COPYRIGHT_YEAR)) + "\n" +
           ...
           "\n" +
           FormatParagraph(strprintf("Copyright (C) %i The BitcoinEco Developers", 2021)) + "\n" +
           "\n" +
           FormatParagraph(strprintf(_("Please contribute if you find BitcoinEco useful. "
