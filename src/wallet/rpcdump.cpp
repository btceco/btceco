...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"bitcoinecoaddress\"\n"
            "\nReveals the private key corresponding to 'bitcoinecoaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"bitcoinecoaddress\"   (string, required) The bitcoineco address for the private key\n"
            "\nResult:\n"
