...
#if defined(NDEBUG)
# error "BitcoinEco cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "BitcoinEco Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // BitcoinEco also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // BitcoinEco also requires low S in sigs
