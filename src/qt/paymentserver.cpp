...
const QString BITCOIN_IPC_PREFIX("bitcoineco:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/bitcoineco-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/bitcoineco-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/bitcoineco-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click bitcoineco: links
...
//
// OSX-specific way of handling bitcoineco: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in bitcoineco: URIs
