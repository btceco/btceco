...
These are the dependencies currently used by BitcoinEco. You can find instructions for installing them in the `build-*.md` file for your platform.
...
Telegram - https://t.me/bitcoineconl
Keybase  - https://keybase.io/team/bitcoineco/
